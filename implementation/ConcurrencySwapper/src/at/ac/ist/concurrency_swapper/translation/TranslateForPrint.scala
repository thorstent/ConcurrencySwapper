...
import at.ac.ist.concurrency_swapper.helpers.ExpressionHelpers

trait TranslateForPrint {
  def printEdge(edge:CFAEdge): String = ExpressionHelpers.printEdge(edge)
}
